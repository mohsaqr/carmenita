...
/**
 * Quiz-taking page. Loads the quiz, starts an attempt, runs the quiz
 * runner state machine, submits on finish, and redirects to results.
 *
 * The selection UI lives here (not in the runner) so that mcq-multi
 * users can build up their selection before clicking Submit.
 */
